...
// wires both into an explorer's fs. R3-159 adds the into-stage twin (the launch
// actor + its declared-contract list), so a consumer offered `inPlaceFor` can act on it.
export { DECLARED_TASKS, DECLARED_LAUNCHES, MAX_MARKER_BYTES, openInPlace, openWith, probeOffer, readMarker } from "./openWith";
